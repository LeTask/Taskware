...
local getcustomassets = {
	['taskware/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['taskware/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['taskware/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['taskware/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['taskware/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['taskware/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['taskware/assets/old/info.png'] = 'rbxasset://info.png',
	['taskware/assets/old/pin.png'] = 'rbxasset://pin.png',
	['taskware/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['taskware/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['taskware/assets/old/search.png'] = 'rbxasset://search.png',
	['taskware/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['taskware/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['taskware/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['taskware/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['taskware/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['taskware/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['taskware/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['taskware/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('taskware/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('taskware/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('taskware/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('taskware/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('taskware/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('taskware/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('taskware/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('taskware/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('taskware/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('taskware/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('taskware/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('taskware/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('taskware/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('taskware/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('taskware/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('taskware/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('taskware/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('taskware/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
TaskLogoV4.Size = UDim2.fromOffset(43, 30)
TaskLogoV4.Position = UDim2.new(1, 1, 0, -2)
TaskLogoV4.BackgroundColor3 = Color3.new()
TaskLogoV4.BackgroundTransparency = 1
TaskLogoV4.BorderSizePixel = 0
TaskLogoV4.Image = getcustomasset('taskware/assets/old/textv4.png')
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		TaskLogo.Position = right and UDim2.new(1 / TaskTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		...
		TaskLabelHolder.Position = UDim2.fromOffset(4, 4 + (TaskLogo.Visible and TaskLogo.Size.Y.Offset or 0))
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		TaskLogoGradient2.Color = mainapi.GUIColor.Rainbow and TaskLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in TaskLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or TaskLogoGradient.Color.Keypoints[2].Value)
		end
	end
