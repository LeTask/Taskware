...
run(function()
	...
	InfiniteStamina = taskware.Categories.Blatant:CreateModule({
...
run(function()
	...
	AutoEat = taskware.Categories.Utility:CreateModule({
		Name = 'AutoEat',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoPickup = taskware.Categories.Utility:CreateModule({
		Name = 'AutoPickup',
		Function = function(callback)
			if callback then 
